            ...
            <div className="w-full max-w-6xl">
                ...
                <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projects.map((project) => (
                        <div key={project.id} className="group relative p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm hover:bg-white/[0.08] hover:border-white/20 transition-all">
                            <div className="aspect-video w-full rounded-xl bg-black/40 border border-white/5 mb-6 flex items-center justify-center text-blue-100/20 group-hover:text-blue-100/40 transition-colors overflow-hidden relative">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/5 to-purple-500/5 group-hover:opacity-100 opacity-0 transition-opacity" />
                            </div>
                            <h3 className="text-xl font-bold text-white mb-3 group-hover:text-blue-400 transition-colors uppercase tracking-tight">{project.title}</h3>
                            <p className="text-sm md:text-base text-blue-100/60 leading-relaxed mb-6 h-12 line-clamp-2">{project.desc}</p>
                            <Link
